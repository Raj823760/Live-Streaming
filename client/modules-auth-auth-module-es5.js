...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-auth-auth-module"], {
  ...
  function srcAppModulesAuthAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AuthModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _auth_routing_module__WEBPACK_IMPORTED_MODULE_5__["AuthRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"]]
    })], AuthModule);
    /***/
  },
  ...
  function srcAppModulesAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_services_utilities_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    /*#__PURE__*/
    function () {
      function LoginComponent(_auth, activated, utility, router) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.activated.queryParamMap.subscribe(function (query) {
            console.log('Code:', query.get('code'));

            if (query.has('code')) {
              _this._auth.getAuthorized(query.get('code')).subscribe(function (authenticate) {
                ...
                _this.utility.setUserDetails(JSON.stringify(info));

                _this.utility.setToken(authenticate.token.access_token);
          ...
          this._auth.getAuthenticateUrl().subscribe(function (url) {
            console.log('URL: ', url);
            _this.url = url;
          });
        }
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AuthService, [{
        key: "getAuthenticateUrl",
        value: function getAuthenticateUrl() {
          return this._http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/url');
        }
      }, {
        key: "getAuthorized",
        value: function getAuthorized(code) {
          return this._http.get("".concat(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl, "/auth/google-auth?code=").concat(code));
        }
      }]);
  ...
  function srcAppServicesUtilitiesServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(UtilitiesService, [{
        ...
        key: "setUserDetails",
        value: function setUserDetails(info) {
